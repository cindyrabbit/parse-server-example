...
var MandrillAdapter = mandrillOptions => {
  ...
  var sendVerificationEmail = options => {
    var message = {
      ...
      html: mandrillOptions.verificationBody,
      global_merge_vars: [
        ...
        { name: 'displayName', content: options.user.get("displayName")},
        { name: 'link', content: options.link},
        { name: 'COMPANY', content: mandrillOptions.company},
        { name: 'link_website', content: mandrillOptions.link_website},
        { name: 'link_email', content: mandrillOptions.link_email},
        { name: 'link_weibo', content: mandrillOptions.link_weibo},
        { name: 'link_wechat', content: mandrillOptions.link_wechat},
        { name: 'icon_weibo',  content: mandrillOptions.icon_weibo},
        { name: 'icon_wechat', content: mandrillOptions.icon_wechat}
      ]
    }
