...
module.exports = (siteRoot, options) => {
  ...
  var server = {
    ...
    databaseURI: process.env.DATABASE_URI || 'mongodb://chris:870807@localhost:27017/dev',
    serverURL: (process.env.SERVER_URL || 'http://localhost:1338') + '/parse',
  ...
  function loadConfigFile(filename) {
    try {
      ...
      Object.assign(server.filesAdapter, config.server.filesAdapter);
